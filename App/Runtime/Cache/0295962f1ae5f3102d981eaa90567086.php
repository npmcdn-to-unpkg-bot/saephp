...
<script src="__PUBLIC__/js/jquery.md5.js"></script>
 <script src="__PUBLIC__/js/user.js"></script>
  ...
  <div class='ceneter_div'>
	<div><input  id='name' placeholder='名字'/></div>
	<div><input id='pwd' placeholder='密码' type='password'/></div>
	<div><input  class='ceneter_input' id='summit' value='提交'type='button'></input></div>
  </div>
